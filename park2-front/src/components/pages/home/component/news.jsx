    ...
    render() {
        return (
            <div className='newsWrapper'>
                <div id="home_newsArea">
                    ...
                    <div id="home_news">
                        ...
                        <div id="home_newsContent">
                            <div className="flip"><span>標題+公告時間</span>
                                <img src="./icon/arrow_B.gif" />
                            </div>
                            <div className="panel home_newsText">
                                <p>內容</p>
                            </div>
                            <div className="flip1"><span>標題+公告時間</span><img src="./icon/arrow_B.gif" /></div>
                            <div className="panel1 home_newsText">
                                <p>內容</p>
                            </div>
                            <div className="flip2"><span>【標題+公告時間</span><img src="./icon/arrow_B.gif" /></div>
                            <div className="panel2 home_newsText">
                                <p>內容</p>
                            </div>
                            <div className="flip3"><span>標題+公告時間</span><img src="./icon/arrow_B.gif" /></div>
                ...
                <div>
                    <img className="home_buttom" src="./img/news_bottom.svg" />
                </div>
            </div>
        );
    }
