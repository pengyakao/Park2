        ...
        return (
            <div className='weatherWrapper'>
                <div id="home_weatherArea">
                    <div>
                        <img className="home_buttom" src="./img/FAQ_bottom.svg" />
                    </div>
                    ...
                    <div id="home_weather">
                        ...
                        <div id="home_weather72">
                            <div id="home_weatherDate">
                                <span className="displaydate" id="home_weatherdata1">5/27</span>
                                <span id="home_weatherdata2">5/28</span>
                                <span id="home_weatherdata3">5/29</span>
                                <span id="home_weatherdata4">5/30</span>
                            </div>
                            <div id="home_weatherDrop">
                    ...
                    <div>
                        <img className="home_buttom" src="./img/weather_bottom.svg" />
                    </div>
                </div>
            </div>
        );
